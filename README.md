...
## Como adicionar logos do Google Drive
...
- Evite espaços e caracteres especiais no nome do arquivo, quando possível.
- Se houver mais de uma versão (ex.: branco, preto e original), mantenha o mesmo prefixo no nome.
